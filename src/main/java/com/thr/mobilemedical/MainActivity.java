...
public class MainActivity extends Activity implements OnClickListener {
	...
	private LinearLayout mGroupAll;
	// 今日入院
	@ViewInject(R.id.ll_inpatient)
	private LinearLayout mGroupIn;
	// 今日出院
	@ViewInject(R.id.ll_outpatient)
	private LinearLayout mGroupOut;
	// 今日手术
	@ViewInject(R.id.ll_operationpatient)
	private LinearLayout mGroupOperation;
	// 特级护理
	@ViewInject(R.id.ll_speciallevelpatient)
	// 一级护理
	private LinearLayout mGroupSpecialLevel;
	@ViewInject(R.id.ll_onelevelpatient)
	private LinearLayout mGroupOneLevel;
	// 二级护理
	@ViewInject(R.id.ll_twolevelpatient)
	private LinearLayout mGroupTwoLevel;
	// 三级护理
	@ViewInject(R.id.ll_threelevelpatient)
	private LinearLayout mGroupThreeLevel;
	...
	private List<Patient> mPatientShow; // 显示病患列表
